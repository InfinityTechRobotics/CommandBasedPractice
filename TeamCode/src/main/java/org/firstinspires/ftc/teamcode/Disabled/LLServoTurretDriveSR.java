...
// Teleop to automatically control servo such that it rotates towards an AprilTag that is detected by Limelight camera.
// Robot drive is using hardware file

@Disabled
@TeleOp

public class LLServoTurretDriveSR extends LinearOpMode {
...
//                range = desiredTag.ftcPose.range;
                ...
                telemetry.addData("New Position",newPos);
