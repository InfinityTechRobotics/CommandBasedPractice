...
import org.firstinspires.ftc.teamcode.pedroPathing.Constants;
    ...
    @Disabled
    @Autonomous
        public class redGoalPickUp6 extends OpMode {
    ...
    //    private final Pose viewPose = new Pose(80, 120, Math.toRadians(90)); // Pose to read the Obelisk.
        ...
        private final Pose downGate = new Pose(135, 51.8, Math.toRadians(20));

        private final Pose controlPointDriveToGate = new Pose(104, 58);

        private final Pose controlPointDriveToAwayFromGate = new Pose(100, 33);
