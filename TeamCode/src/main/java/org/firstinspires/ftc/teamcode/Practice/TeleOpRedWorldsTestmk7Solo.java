...
@Configurable
@TeleOp
public class TeleOpRedWorldsTestmk7Solo extends OpMode {
    ...
    double DRIVE_POWER_FACTOR = 0.5;
    double DRIVE_POWER_FACTOR_LOW = 0.4;
    double DRIVE_POWER_FACTOR_HIGH = 0.6;
