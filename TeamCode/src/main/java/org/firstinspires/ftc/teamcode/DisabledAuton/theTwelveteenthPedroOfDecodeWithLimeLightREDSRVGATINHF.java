...
@Disabled
@Autonomous(name = "theTwelveteenthPedroOfDecodeWithLimeLightREDSRVGATINHF", group = "pedroPathing")
    public class theTwelveteenthPedroOfDecodeWithLimeLightREDSRVGATINHF extends OpMode {
