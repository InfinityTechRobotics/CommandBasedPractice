...
//@Configurable
@TeleOp
public class TeleOpRedStatesTestRevAlignment extends OpMode {
    ...
    double LONG_DISTANCE_ALIGNMENT_CORRECTION = 4;
...
//        panelsTelemetry.update(telemetry);
    ...
    public void loop() {
        ...
        if (targetFound) {
            ...
            if (distanceToGoalInches >= 100) {
                error = bearing + LONG_DISTANCE_ALIGNMENT_CORRECTION;
            }else {
                error = bearing;
            }
