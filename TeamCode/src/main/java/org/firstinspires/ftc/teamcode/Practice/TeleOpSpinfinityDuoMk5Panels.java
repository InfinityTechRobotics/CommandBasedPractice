...
//@Configurable
@TeleOp
public class TeleOpSpinfinityDuoMk5Panels extends OpMode {
...
//        panelsTelemetry.addData("Paddle Servo Position", shooter.servoPaddlePosition());
        ...
        panelsTelemetry.addData("Turret Current", shooter.getMotorTurretCurrent());
        panelsTelemetry.addData("Flywheel 1 Current", flywheel.getMotorFlywheel1Current());
        panelsTelemetry.addData("Flywheel 2 Current", flywheel.getMotorFlywheel2Current());
        panelsTelemetry.update(telemetry);
