...
@Autonomous
    ...
    public class autoRedStateTestIntakeOff extends OpMode {
    ...
    private final Pose gateHit = new Pose(128, 79, Math.toRadians(90));
    ...
    private PathChain driveToGoal, driveToPrePickup23, driveToPickup23, driveToGate, driveToGoal23, driveToGoalGate, driveToPrePickup22, driveToPickup22, driveToGoal22, driveToPrePickup21, driveToPickup21, driveToGoal21, driveToEnd;

    double flywheelRPM = 0.;

    double TARGET_AUTON_RPM = 2250.0;
    ...
    public void loop() {
        ...
        flywheel.setFlywheelVel(TARGET_AUTON_RPM);
