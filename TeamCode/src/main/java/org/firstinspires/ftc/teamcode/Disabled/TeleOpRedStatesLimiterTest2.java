...
//@Configurable
@TeleOp
public class TeleOpRedStatesLimiterTest2 extends OpMode {
...
//        currentPower = y;
        currentPower = limiter(y, previousPower);
        ...
        tankMoveRobot(currentPower, powerFactor);
        ...
        telemetry.addData("Previous Power", previousPower);
    ...
    public void tankMoveRobot (double currentPower, double powerFactor) {

        double frontLeftPower = currentPower;
        double backLeftPower = currentPower;
        double frontRightPower = currentPower;
        double backRightPower = currentPower;
