...
@Disabled
@Autonomous
public class redGoalPickUpskrTest extends OpMode {
    ...
    private final Pose pickupPose22 = new Pose(126, 63, Math.toRadians(0)); // Middle (Second Set) of Artifacts from the Spike Mark(PGP).
    ...
    private final Pose gatePickup = new Pose(125, 62, Math.toRadians(20));

    private final Pose controlPointDriveToGate = new Pose(104, 56); //(104, 46)

    private final Pose controlPointDriveToAwayFromGate = new Pose(105, 36);
    ...
    private void buildPaths() {
        ...
        driveToAwayFromGate = follower.pathBuilder()
                .addPath(new BezierCurve(gatePickup, controlPointDriveToAwayFromGate, scorePose))
