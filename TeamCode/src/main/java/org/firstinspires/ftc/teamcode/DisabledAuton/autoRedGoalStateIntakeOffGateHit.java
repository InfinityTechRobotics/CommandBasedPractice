...
import org.firstinspires.ftc.teamcode.pedroPathing.Constants;
    ...
    @Disabled
    @Autonomous
    public class autoRedGoalStateIntakeOffGateHit extends OpMode {
...
//    private final Pose viewPose = new Pose(80, 120, Math.toRadians(90)); // Pose to read the Obelisk.
    ...
    private final Pose prePickupPose22 = new Pose(92, 65, Math.toRadians(0)); // Preparing to intake second set of artifacts.

    private final Pose pickupPose22 = new Pose(129, 65, Math.toRadians(0)); // Middle (Second Set) of Artifacts from the Spike Mark(PGP).
    ...
    private final Pose preGateHit = new Pose(118, 75, Math.toRadians(90));

    private final Pose gateHit = new Pose( 124, 75, Math.toRadians(90));
    ...
    private PathChain driveToMotif, driveToGoal, driveToPrePickup23, driveToPickup23, driveToGoal23, driveToPrePickup22, driveToPickup22, driveToGoal22, driveToPrePickup21, driveToPickup21, driveToGoal21, driveToEnd, driveToGate, driveGateToGoal;
...
//                .build();
        ...
        driveToGoal21= follower.pathBuilder()
                .addPath(new BezierCurve(pickupPose21, scorePose))
