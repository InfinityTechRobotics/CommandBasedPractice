...
//@Configurable
@TeleOp
public class TeleOpRedStatesTestRev4BallLight extends OpMode {
...
//        panelsTelemetry.update(telemetry);
    ...
    public void loop() {
        ...
        if (counter >= 4) {
            artifactIndicator1.setPosition(0.300);
            artifactIndicator2.setPosition(0.300);
            artifactIndicator3.setPosition(0.300);
        }else {
            artifactIndicator1.setPosition(0);
            artifactIndicator2.setPosition(0);
            artifactIndicator3.setPosition(0);
