...
import org.firstinspires.ftc.teamcode.pedroPathing.Constants;
    ...
    @Disabled
    @Autonomous
        public class redGoalPickUp2 extends OpMode {
    ...
    //    private final Pose viewPose = new Pose(80, 120, Math.toRadians(90)); // Pose to read the Obelisk.
        ...
        private final Pose gatePickup = new Pose(131, 59, Math.toRadians(45));

        private final Pose controlPointDriveToGate = new Pose(104.5, 46.4);

        private final Pose controlPointDriveAwayFromGate = new Pose(110, 30);
