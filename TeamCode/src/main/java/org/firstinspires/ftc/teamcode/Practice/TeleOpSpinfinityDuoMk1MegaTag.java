...
@Configurable
@TeleOp
public class TeleOpSpinfinityDuoMk1MegaTag extends OpMode {
...
//        panelsTelemetry.addData("Intake On", intakeOn);
        ...
        panelsTelemetry.debug("Robot Position", follower.getPose());
        panelsTelemetry.debug("Robot X Position", robotXPos);
        panelsTelemetry.debug("Robot Y Position", robotYPos);
        panelsTelemetry.debug("Robot Heading", Math.toDegrees(botHeading));
