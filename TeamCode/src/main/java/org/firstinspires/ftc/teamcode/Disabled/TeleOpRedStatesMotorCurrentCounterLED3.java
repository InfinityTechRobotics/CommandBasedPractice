...
//@Configurable
@TeleOp
public class TeleOpRedStatesMotorCurrentCounterLED3 extends OpMode {
    ...
    public void loop() {
        ...
        if (counter >= 3) {
            artifactIndicator3.setPosition(0.7);
        } else {
            artifactIndicator3.setPosition(1);
        }

        if (counter >= 2) {
            artifactIndicator2.setPosition(0.7);
        } else {
            artifactIndicator2.setPosition(1);
        }

        if (counter >= 1) {
            artifactIndicator1.setPosition(0.7);
        }else {
            artifactIndicator1.setPosition(1);
        }
