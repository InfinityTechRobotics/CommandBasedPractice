...
@Disabled
@TeleOp(name="Auto Drive To AprilTag", group = "TeleOp")
public class AutoDriveToAprilTag extends LinearOpMode {
    ...
    @Override public void runOpMode()
    {
        ...
        leftBackDrive  = hardwareMap.get(DcMotor.class, "motorRearLeft");
        rightBackDrive = hardwareMap.get(DcMotor.class, "motorRearRight");
