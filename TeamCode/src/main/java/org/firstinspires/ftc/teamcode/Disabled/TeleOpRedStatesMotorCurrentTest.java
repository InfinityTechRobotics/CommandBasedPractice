...
public class TeleOpRedStatesMotorCurrentTest extends OpMode {
    ...
    public void loop() {
        ...
        panelsTelemetry.addData("Intake Power", motorIntake.getPower());
        panelsTelemetry.addData("Transfer Current", transferCurrent);
        panelsTelemetry.addData("Transfer Power", motorTransfer.getPower());
        panelsTelemetry.addData("Flywheel Current", flywheelCurrent);
        panelsTelemetry.addData("Flywheel Power", motorFlywheel.getPower());
