...
@Autonomous
public class REDNearWith21 extends OpMode {
    ...
    private  final Pose endPose = new Pose(90, 67, Math.toRadians(0));//it's the end - if you took the time to read this, you get it - otherwise vid the auton eyelid is dissapointed :(
