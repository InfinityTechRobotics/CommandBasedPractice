...
@Autonomous
    ...
    public class autoBlueStateTestIntakeOff extends OpMode {
    ...
    private final Pose scorePose = new Pose(56, 93, Math.toRadians(138)); // Scoring Pose of our robot. It is facing the goal at a 135 degree angle.    Pose(54, 98, Math.toRadians(135));
    ...
    private final Pose prePickupPose23 = new Pose(50, 82.5, Math.toRadians(180)); // Preparing to intake first set of artifacts.

    private final Pose pickupPose23 = new Pose(26, 82.5, Math.toRadians(180));// Highest (First Set) of Artifacts from the Spike Mark(PPG).

    private final Pose gateHit = new Pose(222, 79, Math.toRadians(90));
