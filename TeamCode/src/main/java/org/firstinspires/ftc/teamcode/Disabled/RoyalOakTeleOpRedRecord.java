...
@Disabled
@TeleOp
public class RoyalOakTeleOpRedRecord extends OpMode {
    ...
    public void loop() {
        ...
        // Set Flywheel Power
        if (autoRPM) {
            // dynamically set flywheel speed based off of Limelight distance measurement
        ...
        // Calculate and set flywheel motor power
