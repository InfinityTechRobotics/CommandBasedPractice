...
@Disabled
    @Autonomous
        public class redGoalPickUp1 extends OpMode {
    ...
    //    private final Pose viewPose = new Pose(80, 120, Math.toRadians(90)); // Pose to read the Obelisk.
        ...
        private final Pose gatePickup = new Pose(132.25, 60, Math.toRadians(45));

        private final Pose controlPointDriveToGate = new Pose(104.5, 46.4);

        private final Pose controlPointDriveAwayFromGate = new Pose(116, 36.3);
        ...
        private PathChain driveToGoal, driveToPrePickup23, driveToPickup23, driveToGoal23, driveToPrePickup22, driveToPickup22, driveToGatePickup, driveToAwayFromGate, driveToGoal22, driveToPrePickup21, driveToPickup21, driveToGoal21, driveToEnd, driveToGate, driveGateToGoal;
        ...
        private void buildPaths() {
            ...
            driveToAwayFromGate = follower.pathBuilder()
                    .addPath(new BezierCurve(gatePickup, controlPointDriveAwayFromGate, scorePose))
        ...
        public void autonomousPathUpdate() {
            switch (pathState) {
                ...
                case 11:
                    ...
                    break;
                case 1000:
                    if (shootingSequenceFlag == 23102221) {
                        shootingSequenceFlag = 777;
                    } else if (shootingSequenceFlag == 231022) {
                        shootingSequenceFlag = 23102221;
                    } else if (shootingSequenceFlag == 2310) {
                        shootingSequenceFlag = 231022;
                    } else if (shootingSequenceFlag == 1) {
                        shootingSequenceFlag = 23;
                    } else if (shootingSequenceFlag == 23) {
                        shootingSequenceFlag = 2310;
                    }
                    setPathState(1001);
                    break;
                case 1001:
...
//                        setPathState(210);
                    } else if (shootingSequenceFlag == 23102221) {
                        setPathState(210);
