...
@Disabled
@Autonomous
    public class altAutoRedAnnArborv4 extends OpMode {
    ...
    private final Pose leavePose = new Pose(110, 18, Math.toRadians(0));
    ...
    private final Pose prePickupPoseLoadingZone = new Pose(143, 36, Math.toRadians(270));
    private final Pose pickupPoseLoadingZone = new Pose(143, 16, Math.toRadians(270));

    private PathChain driveToScore, driveToLeave, driveToPrePickup21, driveToPickup21, driveToPrePickupLoadingZone, driveToPickupLoadingZone, driveToLoadingScore;
    ...
    private void buildPaths() {
        ...
        driveToPrePickupLoadingZone = follower.pathBuilder()
                .addPath(new BezierLine(scorePose, prePickupPoseLoadingZone))
        ...
        driveToLoadingScore = follower.pathBuilder()
                .addPath(new BezierLine(pickupPoseLoadingZone, scorePose))
    ...
    public void autonomousPathUpdate() {
        switch (pathState) {
            ...
            case 1001:
                ...
                break;
            case 10001:
                if (pathTimer.getElapsedTimeSeconds() > 0.5) { // changed from 0.5 to 0.25
