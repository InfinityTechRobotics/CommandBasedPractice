...
import org.firstinspires.ftc.teamcode.pedroPathing.Constants;
    ...
    @Disabled
    @Autonomous
        public class redGoalPickUp3 extends OpMode {
    ...
    //    private final Pose viewPose = new Pose(80, 120, Math.toRadians(90)); // Pose to read the Obelisk.
        ...
        private final Pose gatePickup = new Pose(132, 58.5, Math.toRadians(45));

        private final Pose controlPointDriveToGate = new Pose(104, 46);

        private final Pose controlPointDriveAwayFromGate = new Pose(110, 36);
