...
@Disabled
@TeleOp
public class TeleOpRedStatesSIS extends OpMode {
...
//        panelsTelemetry.update(telemetry);
    ...
    public void loop() {
        ...
        // Driver Controls
        double y = squareInputWithSign(-gamepad1.left_stick_y);
        double x = squareInputWithSign(gamepad1.left_stick_x * 1.1);
