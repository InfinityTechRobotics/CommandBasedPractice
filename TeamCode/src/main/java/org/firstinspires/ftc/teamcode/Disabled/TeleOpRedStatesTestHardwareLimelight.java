...
import org.firstinspires.ftc.teamcode.DisabledHardware.Limelight;
...
@Disabled
@TeleOp
public class TeleOpRedStatesTestHardwareLimelight extends OpMode {
    ...
    public void loop() {
        ...
        LLResult result = limelight.getLimelightResult();
